---
title: Configuration
description: Multi-guild setup and settings for Alphapy.
---
...
- `GOOGLE_CREDENTIALS_JSON`: Google service account key as a JSON string (Railway env var or `.env`). Required for Drive PDF features (`/learn_topic`, etc.). See [GOOGLE_CREDENTIALS_SETUP.md](../google_credentials_setup/).
