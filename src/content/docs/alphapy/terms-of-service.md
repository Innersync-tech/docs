---
title: Innersync • Alphapy Bot Terms of Service
---
...
- Users must be at least 13 years old or meet Discord's minimum age requirements in their jurisdiction.
...
- Use the Bot only for lawful purposes and in compliance with applicable regulations including the Belgian Data Protection Act (Wet van 30 juli 2018) and GDPR requirements.
...
## 7. Financial and Educational Disclaimer
...
Any disputes arising from these Terms shall be subject to the exclusive jurisdiction of the Belgian courts. For users in Belgium, you may also contact the Gegevensbeschermingsautoriteit (GBA) for data protection related disputes.

## 17. Contact

Questions about these Terms? Contact the project maintainer at `support@innersync.tech` or open an issue on the GitHub repository.
